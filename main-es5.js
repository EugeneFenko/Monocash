...
var CurenciesComponent = /** @class */ (function () {
    function CurenciesComponent(httpService) {
        this.httpService = httpService;
        this.currency = [];
        this.inputValue = 1;
    }
    CurenciesComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    CurenciesComponent.ctorParameters = function () { return [
